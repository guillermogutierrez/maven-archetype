...
public class ApplicationConfig extends WebSecurityConfigurerAdapter {
  ...
  private static final String V1_MENU_ENDPOINT = "${apiPath}";
  private static final String V1_MENU = "${apiPath}/**";
  private static final String V2_MENU_ENDPOINT = "/v2/menu";
  private static final String V2_MENU = "/v2/menu/**";

  @Value(value = "${symbol_dollar}{auth.apiAudience}")
  private String apiAudience;

  @Value(value = "${symbol_dollar}{auth.issuer}")
  private String issuer;

  @Value(value = "${symbol_dollar}{auth.isEnabled}")
