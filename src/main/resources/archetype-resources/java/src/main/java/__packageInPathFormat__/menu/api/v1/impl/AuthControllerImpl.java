...
import ${package}.menu.api.v1.AuthController;
import ${package}.menu.api.v1.dto.request.GenerateTokenRequest;
import ${package}.menu.api.v1.dto.response.GenerateTokenResponse;
...
public class AuthControllerImpl implements AuthController {
  ...
  private static final String RESOURCE_URL = "https://amido${artifactId}.eu.auth0.com/oauth/token";
