...
public class OpenApiConfiguration {
  ...
  private static final String PROJECT_URL = "https://github.${packageInPathFormat}-java";
  private static final String STACKS_EMAIL = "${artifactId}@amido.com";
